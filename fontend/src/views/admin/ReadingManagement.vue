          ...
          <div class="modal-body">
            <form @submit.prevent="submitForm" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <select class="form-control" id="part" v-model="newBaiDoc.part" style="padding: 6px 0px;">
              ...
              <div class="form-group">
                ...
                <select class="form-control" id="doKho" v-model="newBaiDoc.doKho" style="padding: 6px 0px;">
