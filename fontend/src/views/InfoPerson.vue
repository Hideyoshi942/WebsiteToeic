...
<template>
  ...
  <div class="container mt-5">
    ...
    <div class="modal" :class="{ fade: !showModal, show: showModal }" style="display: showModal ? 'block' : 'none'; margin-top: 9%;">
    ...
    <!-- Modal Đổi Mật Khẩu -->
    <div class="modal" :class="{ fade: !showPasswordModal, show: showPasswordModal }" style="display: showPasswordModal ? 'block' : 'none'; margin-top: 9%;">
      <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content">
          <div class="modal-header bg-primary text-white">
